    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {displayApprovals.map((approval, index) => {
          ...
          const pushedRecord = pushedToManufacturing.find((p) => p.taskId === approval.taskId);
          const isPushed = !!pushedRecord;
                  ...
                  <div className="mt-5 pt-5 border-t border-border animate-fade-in">
                    <div className="grid grid-cols-3 gap-6">
                        ...
                        <div>
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="flex flex-col items-center">
                              ...
                              {isPushed && pushedRecord && (
                                <>
                                  <span className="text-[10px] mt-0.5 whitespace-nowrap text-success">
                                    {formatDate(pushedRecord.pushedAt)}
                                  </span>
                                  <span className="text-[10px] mt-0.5 whitespace-nowrap text-text-muted">
                                    {pushedRecord.pushedBy}
                                  </span>
                                </>
                              )}
                              {!isPushed && level2Status === 'approved' && (
                                <span className="text-[10px] mt-0.5 whitespace-nowrap text-accent">
                                  待推送
                                </span>
                              )}
                              {!isPushed && level2Status !== 'approved' && (
                      ...
                      <div className="space-y-3">
                        ...
                        {isPushed && pushedRecord && (
                          <div className="p-4 bg-success/5 rounded-lg border border-success/20">
                            <p className="text-xs text-success/80 mb-1">推送至制造工艺组</p>
                            <p className="text-sm font-medium text-success">
                              {pushedRecord.pushedBy}
                            </p>
                            <p className="text-xs text-success/70 mt-1">
